// Phases for workflow: ❤️ Employee Directory
      
import { Employee_Directory_FieldIds, Employee_Directory_PhaseIds } from "../enums";
      
export const phases: HailerPhaseUpdatePayload[] = [
  {
    _id: Employee_Directory_PhaseIds.active_employees_e57,
    announcementFields: [
      "654245fac9a762197e96ce93",
      Employee_Directory_FieldIds.position_e6f,
      "654245fac9a762197e96ce94"
    ],
    ...
    primaryDateField: Employee_Directory_FieldIds.starting_date_e79
  },
  {
    _id: Employee_Directory_PhaseIds.active_contractors_e95,
    announcementFields: [],
    announcementFieldsOrder: [],
    announcementRecipients: [],
    description: "",
    ...
    possibleNextPhaseSettings: {},
    primaryDateField: Employee_Directory_FieldIds.probation_end_date_e7e
  },
  {
    _id: Employee_Directory_PhaseIds.archive_e96,
    announcementFields: [],
    announcementFieldsOrder: [],
    announcementRecipients: [],
    description: "",
